...
export const STYLE_PROMPTS: Record<string, string> = {
  ...
  [RenderStyle.DESERT_RUIN]: "Desert Ruin style. Match the specific aesthetic of the provided reference images: 'Beffio' style ancient/colonial ruins. Materials: Peeling pastel paint (faded pinks, teals, ochres) revealing red brick and rough stone underneath. Intricate weathered plaster details, grime, and sand accumulation in crevices. Post-apocalyptic but vibrant and painterly textures. Elements of cloth tarps, vegetation growing in cracks, and scattered debris. Warm, high-contrast desert sunlight. The look should be like a high-quality 3D game asset of an abandoned ornate building. STRICTLY PRESERVE INPUT GEOMETRY, but wrap it in these rich, detailed textures.",
