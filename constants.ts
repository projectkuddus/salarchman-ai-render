...
export const INTERIOR_STYLE_PROMPTS: Record<string, string> = {
  ...
  [InteriorStyle.AMBER_TEXTURED]: "Amber Textured Minimalist style. MANDATORY: All windows and glass surfaces MUST be rendered as translucent, glowing amber panels (backlit onyx/resin). They must emit a strong, warm orange light. There are no clear glass windows; they are all amber light screens. The room is dark and moody, illuminated ONLY by these glowing amber rectangles. Walls are rough textured plaster. Furniture is minimal and silhouetted against the glowing windows. Do not glow TVs.",
