...
export const STYLE_PROMPTS: Record<string, string> = {
  ...
  [RenderStyle.EVENING_LIGHT_2]: "Evening Dramatic / Museum Grade Architectural Photography. Ultra-high-end luxury architectural photography shot at twilight. Deep blue sky with dramatic clouds. Warm, inviting interior lighting (3000K) spilling out onto terraces and pools. Reflections in water/glass. Sharp, crystal clear details, 8k resolution. Atmospheric and moody but clean. The aesthetic of a high-end hotel or luxury residence feature in ArchDaily or Dezeen. STRICTLY PRESERVE INPUT GEOMETRY. Ultimate professional quality.",
