...
export const STYLE_PROMPTS: Record<string, string> = {
  ...
  [RenderStyle.GOLDEN_HOUR_DRAMATIC]: "Dramatic Golden Hour Architectural Photography. Award-winning professional shot. The building is struck by intense, warm golden sunlight (low angle sun) against a dark, moody, storm-grey sky. High contrast lighting. The building glows in warm orange/gold tones while the background and shadows remain deep and cool. Professional architectural photography style, sharp details, cinematic lighting, dramatic atmosphere, 8k resolution. STRICTLY PRESERVE INPUT GEOMETRY. Ultimate realism.",
