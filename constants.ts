...
export const INTERIOR_STYLE_PROMPTS: Record<string, string> = {
  ...
  [InteriorStyle.AMBER_TEXTURED]: "Amber Textured Minimalist style. MANDATORY: All windows/light-panels must be SMOOTH, FROSTED AMBER GLASS. No veins, no marble texture, no lines on the glass. It must be a flat, uniform, glowing orange surface. However, the REST of the room (walls, floor, ceiling) MUST remain ROUGH, TEXTURED, and RAW (plaster/concrete). The contrast is key: perfectly smooth glowing amber rectangles against rough, dark, moody walls. Do not glow TVs.",
