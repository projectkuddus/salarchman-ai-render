...
export const INTERIOR_STYLE_PROMPTS: Record<string, string> = {
  ...
  [InteriorStyle.AMBER_TEXTURED]: "Amber Textured Minimalist style. Crucial: The windows must be rendered as translucent, glowing amber panels (like backlit onyx or frosted orange glass) emitting a soft, warm diffuse light. Warm, moody interior with rough textured plaster walls. Deep amber/orange ambient lighting, strong shadows, minimalist furniture. The light source should come primarily from these glowing window screens. High contrast, cinematic, tactile surfaces.",
