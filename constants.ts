...
export const INTERIOR_STYLE_PROMPTS: Record<string, string> = {
  ...
  [InteriorStyle.AMBER_TEXTURED]: "Amber Textured Minimalist style. MANDATORY: All windows/light-panels must be SMOOTH, UNIFORM, FROSTED AMBER GLASS. They must emit a gentle, sophisticated, diffuse orange glow. NO TEXTURE on the glass itself (avoid veins/cracks/onyx patterns). The glow must be soft and even, like a high-end light box. The room walls should still be rough textured plaster for contrast, but the light sources must be perfectly smooth and clean. Do not glow TVs.",
