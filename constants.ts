...
export const INTERIOR_STYLE_PROMPTS: Record<string, string> = {
  ...
  [InteriorStyle.AMBER_TEXTURED]: "Amber Textured Minimalist style. Key Feature: Large architectural window panels made of translucent amber material (backlit onyx or resin) emitting a soft, warm, diffuse glow. Constraint: Only these architectural panels should glow. Do NOT apply this amber glow to television screens, monitors, or other appliances; keep them neutral or black. The atmosphere is moody, with rough textured plaster walls and deep shadows. The light source is exclusively the warm diffuse light from the amber window partitions.",
