...
export const EXTERIOR_STYLE_THUMBNAILS: Record<string, string> = {
  ...
  [RenderStyle.TRANSLUCENT_ETHEREAL]: '/thumbnails/styles/Translucent Ethereal.png',
  [RenderStyle.SATELLITE_DRONE]: '/thumbnails/styles/satelite to drone.jpg',
  [RenderStyle.EVENING_LIGHT]: '/thumbnails/styles/evening simple.png',
  [RenderStyle.EVENING_LIGHT_2]: '/thumbnails/styles/evening dramatic.png',
  [RenderStyle.GOLDEN_HOUR_DRAMATIC]: '/thumbnails/styles/Dramatic Golden Hour.png',
  [RenderStyle.FOGGY_NIGHT]: '/thumbnails/styles/foggy night.png',
  ...
  [RenderStyle.DESERT_RUIN]: '/thumbnails/styles/Dessert Ruins.png',
  ...
  [RenderStyle.CONCRETE_MODEL]: '/thumbnails/styles/Concret Model.jpg',
  [RenderStyle.WOOD_MODEL]: '/thumbnails/styles/wood model.jpg',
  [RenderStyle.RED_BRICK_MODEL]: '/thumbnails/styles/Red brick model.jpg',
  [RenderStyle.BRONZE_MODEL]: '/thumbnails/styles/Bronze Model.jpg',
  [RenderStyle.RED_CONCRETE_MODEL]: '/gallery/red-concrete-model_thumb.jpg',
  [RenderStyle.CONCRETE_PLANS_MODEL]: '/thumbnails/styles/Concrete and plans model.jpg',
  [RenderStyle.WOOD_VEGETATION_MODEL]: '/thumbnails/styles/wood and vegetation model.jpg',
  [RenderStyle.WOOD_WHITE_MODEL]: '/thumbnails/styles/Wood and White Model.jpg',
  [RenderStyle.DARK_BRUTALIST_MODEL]: '/thumbnails/styles/Dark Brutalist Model.jpg',
  [RenderStyle.GREY_CARDBOARD_MODEL]: '/thumbnails/styles/Grey Card Board Model.jpg',
  [RenderStyle.LEGO_MODEL]: '/thumbnails/styles/Lego Model.jpg',
...
export const STYLE_PROMPTS: Record<string, string> = {
  ...
  [RenderStyle.TRANSLUCENT_ETHEREAL]: "Translucent Ethereal style. Award-winning architectural photography quality. The building is rendered as a glowing, semi-transparent volume, like frosted glass or polycarbonate. Soft internal light emanates from within, revealing the structure. Clean, white, and ethereal aesthetic. Realistic lighting and context (blue hour or dusk). Ultra-sharp focus, 8k resolution, professional composition. STRICTLY PRESERVE INPUT GEOMETRY. Do not change the form or objects, only apply the translucent material and lighting style.",
  [RenderStyle.SATELLITE_DRONE]: "Satellite to Drone view, aerial photography style, realistic context integration, top-down or high angle. High-resolution, sharp details, professional mapping quality.",
  [RenderStyle.EVENING_LIGHT]: "Evening Simple / Blue Hour Architectural Photography. Award-winning professional architectural photography captured on a Pro grade Hasselblad medium format camera. Shot during the 'blue hour' or early evening with perfect exposure. The building is illuminated by warm interior lights (3000K) glowing through the glass, contrasting with the deep blue/twilight sky. Exterior facade lighting highlights the architectural form. Soft, atmospheric, and moody. Perfectly balanced exposure. No noise, sharp details, 8k resolution. Cinematic and emotional atmosphere. IMPORTANT: Generate realistic surrounding landscape and context as per the user's input, seamlessly integrated with the scene. The material palette should be preserved but enhanced by the lighting. Ultimate professional quality.",
  [RenderStyle.EVENING_LIGHT_2]: "Evening Dramatic / Museum Grade Architectural Photography. Ultra-high-end luxury architectural photography shot at twilight, captured on a Pro grade Hasselblad medium format camera. Deep blue sky with dramatic clouds. Warm, inviting interior lighting (3000K) spilling out onto terraces and pools. Reflections in water/glass. Sharp, crystal clear details, 8k resolution. Atmospheric and moody but clean. The aesthetic of a high-end hotel or luxury residence feature in ArchDaily or Dezeen. IMPORTANT: Generate realistic surrounding landscape and context as per the user's input, seamlessly integrated with the dramatic evening mood. STRICTLY PRESERVE INPUT GEOMETRY. Ultimate professional quality.",
  [RenderStyle.GOLDEN_HOUR_DRAMATIC]: "Dramatic Golden Hour Architectural Photography. Award-winning professional shot captured on a Pro grade Hasselblad medium format camera. The building is struck by intense, warm golden sunlight (low angle sun) against a dark, moody, storm-grey sky. High contrast lighting. The building glows in warm orange/gold tones while the background and shadows remain deep and cool. CRITICAL: DO NOT RENDER AN EMPTY OR INFINITY BACKGROUND. You MUST generate a complete, realistic environment around the building. If the user input implies a city, render a detailed urban context with neighboring buildings. If nature, render dense, realistic landscaping, trees, and terrain extending to the horizon. The building must sit in a REAL world location, not a studio void. Ensure all architectural elements are visible and detailed, even in the darker shadow areas. Do not crush the blacks. 8k resolution, ultra-sharp focus. STRICTLY PRESERVE INPUT GEOMETRY. Ultimate realism.",
  [RenderStyle.FOGGY_NIGHT]: "Foggy Night Architectural Photography. Ultra-realistic professional architectural photography. Heavy, atmospheric fog enveloping the scene at night. The building emerges from the mist, illuminated by soft, diffused artificial lights (streetlights, interior glow). Moody, mysterious, and cinematic. Cool blue tones with warm highlights from the lights. High contrast between the lit areas and the dark, foggy surroundings. Sharp details on the building where visible, fading into the fog. 8k resolution, award-winning quality. STRICTLY PRESERVE INPUT GEOMETRY.",
  ...
  [RenderStyle.DESERT_RUIN]: "Desert Ruin style (Beffio asset style). The building is rendered as an ancient or colonial ruin with peeling pastel paint (faded reds, teals, ochres) and weathered plaster. Intricate architectural details, arches, and cornices. Exposed brickwork where plaster has fallen off. Context: Sandy desert floor with scattered debris and rocks. Soft, warm studio lighting with a beige/paper-like background. Isometric or orthographic view. High detail, game asset aesthetic. STRICTLY PRESERVE INPUT GEOMETRY.",
...
export const DIAGRAM_PROMPTS: Record<DiagramType, string> = {
  ...
  [DiagramType.ZONING]: "Zoning Diagram. Clear color-coded volumes showing functional zones (Public, Private, Service). Aesthetic: Clean, infographic style.",
