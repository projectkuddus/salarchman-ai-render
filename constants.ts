...
export const STYLE_PROMPTS: Record<string, string> = {
  ...
  [RenderStyle.EVENING_LIGHT]: "Evening Simple / Blue Hour Architectural Photography. Award-winning professional architectural photography. Shot during the 'blue hour' or early evening with perfect exposure. The building is illuminated by warm interior lights (3000K) glowing through the glass, contrasting with the deep blue/twilight sky. Exterior facade lighting highlights the architectural form. Soft, atmospheric, and moody. Perfectly balanced exposure. No noise, sharp details, 8k resolution. Cinematic and emotional atmosphere. The material palette should be preserved but enhanced by the lighting. Pro-grade Hasselblad quality.",
